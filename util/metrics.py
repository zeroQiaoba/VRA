...
def compute_traditional_ood(base_dir, in_dataset, out_datasets, method, name,intext):
    # print('Natural OOD')
    ...
    known = np.loadtxt(intext+'/in_scores.txt')
    ...
    for out_dataset in out_datasets:
        ...
        novel = np.loadtxt(intext+'/{out_dataset}/out_scores.txt'.format(out_dataset=out_dataset), delimiter='\n')
