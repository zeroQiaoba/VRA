...
class ResNetV2(nn.Module):
    ...
    def __init__(self, block_units, width_factor, head_size=21843, zero_head=False, fix_backbone=False, num_block_open=0, k=None,data_type='No',
                 lamb = 0,featmin=0,featmax=0):
        super().__init__()
